...
export class CalculateService {
  ...
  constructor(private firestoreCalculationsService: FirestoreCalculationsService) { }
  ...
  public addKey(key: any) {
    ...
    switch (key) {
      case '=':
        ...
        this.firestoreCalculationsService.saveCalculation(this.calculation, result);
        this.calculation = '';
        return result;
      break;
      case 'ac':
